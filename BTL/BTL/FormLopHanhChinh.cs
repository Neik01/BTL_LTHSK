...
namespace BTL
{
    public partial class FormLopHanhChinh : Form
    {
        ...
        public string connectionStr = ConfigurationManager.ConnectionStrings["QUANLYGIANGDAY2ConnectionString"].ConnectionString;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string path = $@"{Application.StartupPath}\BaoCao\lophanhchinh\Reportlophanhchinh.rpt";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            report.thongkelophanhchinhtheomalop(txtBoxMaLop.Text);
            report.Show();
        }
